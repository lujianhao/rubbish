...
import { specialEquipmentMaintainSearch, specialEquipmentMaintainSearch1 } from '@/api/specialEquipment'
...
export default {
  ...
  methods: {
    ...
    treeSelect(selectedKeys) {
      ...
      this.bottomTableSearchInfo.tzsb_tzsbdaId = ''
    ...
    topTableRowClick(row) {
      this.bottomTableSearchInfo.tzsb_tzsbdaId = row.p_tzsbda_id
    ...
    searchBottomTableData(type) {
      ...
      this.bottomTableColumns = (bottomTableColumns['specialEquipmentMaintain']).slice(0, (bottomTableColumns['specialEquipmentMaintain']).length - 1)
